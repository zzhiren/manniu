...
export default class MnActionSheet extends React.Component {
    ...
    render() {
        ...
        const rootClass = classNames('mn-action-sheet', {
            'mn-action-sheet--active': _isOpened
        }, className);
        return (React.createElement(View, { className: rootClass, onTouchMove: this.handleTouchMove },
            React.createElement(View, { onClick: this.close, className: 'mn-action-sheet__overlay' }),
            React.createElement(View, { className: 'mn-action-sheet__container' },
                title && React.createElement(MnActionSheetHeader, null, title),
                React.createElement(MnActionSheetBody, null, this.props.children),
                cancelText && (React.createElement(MnActionSheetFooter, { onClick: this.handleCancel }, cancelText)))));
    }
}
